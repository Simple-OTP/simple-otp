...
class _FakeSecretKey_1 extends _i1.SmartFake implements _i3.SecretKey {
  _FakeSecretKey_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockConfiguration extends _i1.Mock implements _i4.Configuration {
  ...
  @override
  String get internalDirectoryPath =>
      (super.noSuchMethod(
  ...
  set requirePassword(bool? value) => super.noSuchMethod(
    Invocation.setter(#requirePassword, value),
  ...
  bool doesDatabaseExist() =>
      (super.noSuchMethod(
            Invocation.method(#doesDatabaseExist, []),
            returnValue: false,
          )
          as bool);

  @override
  _i2.File getDatabaseFile() =>
      (super.noSuchMethod(
  ...
  @override
  List<int> nonce() =>
      (super.noSuchMethod(Invocation.method(#nonce, []), returnValue: <int>[])
          as List<int>);

  @override
  void toggleRequirePassword() => super.noSuchMethod(
    Invocation.method(#toggleRequirePassword, []),
    returnValueForMissingStub: null,
  );
  ...
  _i6.Future<_i3.SecretKey> generateFromPassword(String? password) =>
      (super.noSuchMethod(
            Invocation.method(#generateFromPassword, [password]),
            returnValue: _i6.Future<_i3.SecretKey>.value(
              _FakeSecretKey_1(
                this,
                Invocation.method(#generateFromPassword, [password]),
              ),
